...
const createDeps = (vfs: VfsBus): ShellServiceDeps => ({
  vfs,
  packageManager: { install: vi.fn().mockResolvedValue(undefined) } as unknown as ShellServiceDeps['packageManager'],
  runtimeWorker: { runScript: vi.fn(), onStdout: null, onStderr: null } as unknown as ShellServiceDeps['runtimeWorker'],
