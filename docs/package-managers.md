...
[ADR-0004](adr/0004-package-manager-strategy.md).
...
[compat.md](compat.md#t2-wintertc-minimum-ecma-429).

[ecma429]: https://min-common-api.proposal.wintertc.org/

## Decision

See [ADR-0004](adr/0004-package-manager-strategy.md) for the formal record.
